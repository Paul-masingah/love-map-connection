        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="space-y-6">
              <AIMatchPreview matchType={matchType} />
              
              <Card className="border-purple-200">
                <CardContent className="p-6">
                  <h3 className="font-semibold mb-2">AI-Driven Matchmaking</h3>
                  <p className="text-sm text-gray-600 mb-4">
                    Our algorithm analyzes responses to identify optimal matches based on:
                  </p>
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="flex items-center">
                      <span className="h-2 w-2 rounded-full bg-purple-600 mr-2"></span>
                      <span>Shared values and interests</span>
                    </li>
                    <li className="flex items-center">
                      <span className="h-2 w-2 rounded-full bg-purple-600 mr-2"></span>
                      <span>Complementary traits</span>
                    </li>
                    {matchType === "romantic" && (
                      <>
                        <li className="flex items-center">
